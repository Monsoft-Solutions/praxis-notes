...
ALTER TABLE "client_replacement_program_behaviors" ADD CONSTRAINT "client_replacement_program_behaviors_client_behavior_id_client_behavior_id_fk" FOREIGN KEY ("client_behavior_id") REFERENCES "public"."client_behavior"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
